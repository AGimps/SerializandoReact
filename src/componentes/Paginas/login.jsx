          ...
          <div className="login-box">
            ...
            <form id="Login" /* action={rotas} */>
              <div className="formularioLogin">
                ...
                <Link className="btnLogar" to={"/home"}>
                  Logar
                </Link>
                <Link className="login-register" to={"/cadastro"}>
                  Cadastrar
                </Link>
            ...
            <div className="content-box">
              ...
              <form id="Login" action="Paginas/serializando.html">
                <div className="formularioLogin">
                  ...
                  <div>
                    <a className="login-register" href="Paginas/cadastro.html">
                      Cadastrar
                    </a>
                  </div>
                  <label>
